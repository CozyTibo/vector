"""Cortex Phase 01 Step 1 — ingestion runs, raw append-only rows, connector checkpoints.

Revision ID: 20260508_0030
Revises: 20260507_0029

Replay ordering for downstream consumers: ORDER BY replay_sequence ASC, id ASC.
