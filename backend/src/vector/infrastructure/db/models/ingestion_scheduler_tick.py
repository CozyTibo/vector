"""Cortex ingestion-only Celery Beat tick audit row."""
...
class IngestionSchedulerTick(Base):
    __tablename__ = "ingestion_scheduler_ticks"
    ...
    enqueued_jobs: Mapped[list[dict[str, Any]] | None] = mapped_column(JSONB, nullable=True)
