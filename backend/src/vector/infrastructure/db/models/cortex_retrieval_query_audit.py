"""Phase 07 — durable retrieval query audit trail."""
...
class CortexRetrievalQueryAudit(Base):
    __tablename__ = "cortex_retrieval_query_audit"
    ...
    query_envelope_hash: Mapped[str] = mapped_column(String(128), nullable=False)
    result_legality_class: Mapped[str] = mapped_column(String(64), nullable=False)
    retrieval_query_replay_identity: Mapped[str] = mapped_column(String(128), nullable=False)
    ...
    omission_count: Mapped[int] = mapped_column(Integer, nullable=False, server_default="0")
