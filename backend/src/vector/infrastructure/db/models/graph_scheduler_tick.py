"""Beat planner audit for graph projection lane."""
...
class GraphSchedulerTick(Base):
    __tablename__ = "graph_scheduler_ticks"
    ...
    enqueued_tenant_ids: Mapped[list[Any] | None] = mapped_column(JSONB, nullable=True)
