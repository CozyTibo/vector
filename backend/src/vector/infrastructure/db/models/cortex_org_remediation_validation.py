"""Phase 04 Step 16 — auditable org remediation validation ledger (P04-16)."""
...
class CortexOrgRemediationValidation(Base):
    __tablename__ = "cortex_org_remediation_validations"
    ...
    failure_case_gap_id: Mapped[str | None] = mapped_column(
        String(128),
        ForeignKey("cortex_org_failure_cases.gap_id", ondelete="SET NULL"),
        nullable=True,
    )
