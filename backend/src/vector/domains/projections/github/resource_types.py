...
RT_PULL_REQUEST_COMMIT = "github.pull_request_commit"

GITHUB_RESOURCE_TYPES = frozenset(
    {RT_REPOSITORY, RT_PULL_REQUEST, RT_ISSUE, RT_COMMIT, RT_PULL_REQUEST_COMMIT},
)
