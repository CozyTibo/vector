...
def connector_runtimes() -> tuple[ConnectorRuntime, ...]:
    ...
    from vector.domains.cortex.connectors.calls.adapter import calls_connector_runtime
    from vector.domains.cortex.connectors.github.adapter import github_connector_runtime
    from vector.domains.cortex.connectors.linear.adapter import linear_connector_runtime
    from vector.domains.cortex.connectors.notion.adapter import notion_connector_runtime
    from vector.domains.cortex.connectors.slack.adapter import slack_connector_runtime
