"""Resume convergence after async TCRE instead of legacy Celery phase chaining."""
...
from vector.domains.cortex.convergence.lease import resume_convergence_from_waiting_v1
...
def on_tcre_completed_for_convergence_v1(
    ...
    *,
    ...
    """Update continuation receipts and re-enter convergence worker at phase 07."""
    ...
    _LOGGER.info(
        "convergence_tcre_resume tenant_id=%s pipeline_run_id=%s job_id=%s",
        tenant_id,
        pipeline_run_id,
        tcre_job_id,
    )
