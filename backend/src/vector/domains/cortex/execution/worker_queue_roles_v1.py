"""ECS Celery worker queue roles — ingestion vs substrate (no shared worker starvation)."""

from __future__ import annotations

from typing import Any, Final

# Ingestion lane: connector sync + scheduler (high volume).
CELERY_INGESTION_QUEUES_V1: Final[tuple[str, ...]] = ("cortex_live", "cortex_replay")
# Substrate lane: convergence, identity repair, synthesis jobs (must not starve behind sync).
CELERY_SUBSTRATE_QUEUES_V1: Final[tuple[str, ...]] = ("vector",)
