...
def build_identity_control_plane_pointer_section() -> dict[str, Any]:
    return {
        ...
        "identity_operator_console_http_routes": [
            ...
            "POST /admin/tenants/{tenant_id}/cortex/identity/replay-jobs/enqueue (410 primary; debug ?debug=1)",
            "GET /admin/tenants/{tenant_id}/cortex/identity/worker-tasks/{celery_task_id}",
            "POST /admin/tenants/{tenant_id}/cortex/identity/link-candidates/regenerate-async (410 primary)",
            "POST /admin/tenants/{tenant_id}/cortex/identity/authoritative-replay-async (410 primary)",
            "POST /admin/tenants/{tenant_id}/cortex/identity/backfill/from-canonical-anchors (410 primary)",
