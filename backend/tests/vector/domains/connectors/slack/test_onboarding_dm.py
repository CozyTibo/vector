...
from vector.domains.connectors.slack.onboarding_dm import send_slack_handoff_welcome_dm
...
def test_send_slack_handoff_welcome_dm_uses_postmessage_user_channel_when_ok() -> None:
    ...
    with patch("vector.domains.connectors.slack.onboarding_dm.httpx.Client") as ClientCls:
