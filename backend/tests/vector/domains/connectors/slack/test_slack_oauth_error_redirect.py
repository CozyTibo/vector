...
from vector.domains.connectors.slack.install_state import SlackOAuthStateClaims
from vector.domains.connectors.slack.oauth_flow import slack_oauth_error_frontend_redirect_url
...
def test_slack_oauth_error_redirect_preserves_return_to_from_state() -> None:
    ...
    uid = uuid.uuid4()
    with patch(
        "vector.domains.connectors.slack.oauth_flow.parse_slack_oauth_state_token",
