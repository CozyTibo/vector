...
/** Reconstruction (formerly Reasoning) — TCRE jobs only. */
export default function AdminCortexReasoningLayout() {
  ...
  return (
    <div className="space-y-4">
      <p className="text-sm text-stone-600">Execution reconstruction jobs (async TCRE). Resume is lease-driven after job completion.</p>
