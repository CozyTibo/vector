    ...
    <div className="space-y-4">
      ...
      {!metricsQ.isPending && m ? (
        <div className="space-y-1 text-xs text-stone-600">
          ...
          <p className="rounded-md border border-amber-100 bg-amber-50/60 px-3 py-2 text-amber-950">
            Permanent topology orphans are{" "}
            <span className="font-medium">bounded omission</span> (Phase D4) — do not chase
            deferral_total → 0. See deferral omission card on the cortex overview.
          </p>
        </div>
      ) : null}
